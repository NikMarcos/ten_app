...
class NewsItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create news_item" do
    assert_difference('NewsItem.count') do
      post news_items_url, params: { news_item: { body: @news_item.body, cover: @news_item.cover, news_category: @news_item.news_category, title: @news_item.title } }
    end
  ...
  test "should update news_item" do
    patch news_item_url(@news_item), params: { news_item: { body: @news_item.body, cover: @news_item.cover, news_category: @news_item.news_category, title: @news_item.title } }
